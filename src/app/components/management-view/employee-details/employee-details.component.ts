...
constructor(private readonly _fb: FormBuilder) {}
  getFormGroup() {
   return this._fb.group({
      first_name: new FormControl(this.personData?.first_name, [Validators.required]),
      last_name: new FormControl(this.personData?.last_name, [Validators.required]),
      position: new FormControl(this.personData?.position, [Validators.required]),
      ...
      shift_end: new FormControl(this.personData?.shift_end, [Validators.required]),
      shift_start: new FormControl(this.personData?.shift_start, [Validators.required]),
